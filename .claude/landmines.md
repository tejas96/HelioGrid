...
| An `Enforced by:` named a task that does not carry the obligation | the enforcer found by the row's own disposition, and an owed line written in each task that prints it | 1 |
