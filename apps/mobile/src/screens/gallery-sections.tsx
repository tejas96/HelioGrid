...
/**
 * Stateless sections + shared scaffolding for the dev-only GalleryScreen (split to keep
 * both files under the ~450-line limit). Stateful sections live in GalleryScreen.tsx.
 */

export const TONES = ['neutral', 'success', 'warning', 'danger', 'info', 'accent'] as const;

const STATUSES: ReadonlyArray<[WorkflowStatus, string]> = [
  ['lead', 'Lead'],
