...
import { BloomBackdrop, H1, Small, StepRise, useReduceMotion } from './login-support';
    ...
    <>
      ...
      <View style={styles.fieldGroup}>
        <Input
          ...
          value={phone}
          onChange={(t) => {
            setPhone(t.replace(/\D/g, '').slice(0, PHONE_LEN));
      ...
      <Button
        ...
        fullWidth
        loading={sending}
        disabled={phone.length !== PHONE_LEN || sending}
