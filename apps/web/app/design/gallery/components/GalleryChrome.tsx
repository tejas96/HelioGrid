...
/**
 * Gallery-local demo copy. Both maps are `Record<WorkflowStatus, string>`, so adding a
 * status to the contract is a compile error HERE until the gallery renders it — the
 * gallery cannot silently fall behind the data model. Product screens translate via Lingui.
 */
export const ENGLISH_STATUS: Record<WorkflowStatus, string> = {
  lead: 'Lead',
...
/** Derived from the contract — never a hand-written second list of the same values. */
export const ALL_STATUSES: readonly WorkflowStatus[] = workflowStatusSchema.options;
