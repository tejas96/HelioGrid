            ...
            <ListRow
              ...
              trailing={
                <StatusChip
                  ...
                  label={ENGLISH_STATUS['survey-scheduled']}
                  density="functional"
                />
              }
            />
        ...
        <div className="ds-row">
          {ALL_STATUSES.map((status) => (
            <Demo key={status} label={status}>
              <StatusChip status={status} label={ENGLISH_STATUS[status]} />
            </Demo>
          ))}
        </div>
        <div className="ds-row">
          {ALL_STATUSES.map((status) => (
            <Demo key={status} label={`${status} functional`}>
              <StatusChip status={status} label={ENGLISH_STATUS[status]} density="functional" />
            </Demo>
          ))}
        </div>
