...
/**
 * The ghost control in the page chrome, top-right: a shared desk switches language before anyone
 * signs in (`SCR-M01-01` decision 4). Real, not drawn — it moves the mount's language at once (`F3-04`).
 */
