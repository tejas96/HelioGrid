...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-01-my-day.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-02-mark-won.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-03-mark-lost.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-04-reopen-lead.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-05-agent-setup-settings.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-06-calling-window.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-07-test-agent.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-08-agent-config-history.md`; they are the specification.
**DONE WHEN:**
- Given the owner edits the opening line, when they save, then the wording change takes effect for newly queued calls only after publish (M07-14) — and no edit path weakens the four hard floors (never claims human · never denies AI when asked · instant handoff · full transcription), nor removes the proactive disclosure where the pack flag ships it ON (M07-10, owner ruling 2026-08-04 Q6).
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-09-knowledge-base.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-10-unanswered-questions.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-11-corrections-review-queue.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-12-agent-call-queue.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-13-call-record-detail.md`; they are the specification.
**DONE WHEN:**
- Given a rep corrects an agent outcome, when the correction saves, then the lead shows the rep's read, a review-queue item exists for the owner, and the KB is unchanged until the owner explicitly promotes an answer (M07-25, M07-26).
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-14-escalations.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-15-routing-rules-editor.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-16-ivr-flow-editor.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-17-number-provisioning-wizard.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-18-agent-performance.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-19-call-log.md`; they are the specification.
**DONE WHEN:**
- Given any listed call, when tapped, then transcript and recording (where consented and within retention) open (M07-57); given the unanswered list, then one tap answers into the KB (M07-58).
- Three base states + brief-listed states present at 375px and 1536px with full parity; zero raw colour literals/off-scale values.
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M07-20-agent-usage.md`; they are the specification.
**DONE WHEN:**
...
(M07-46's toggle surface ships in the app shell — verbatim row also carried by `ux/briefs/SCR-SHELL-01-app-shell.md`; this task builds the presence state that ring groups and chains read.)
**DONE WHEN:**
- Given a customer asks for a discount mid-call, when the hand-over rule fires, then the rep is notified immediately with a deep link, and the escalations surface lists the call with its reason (M07-42, M07-43).
