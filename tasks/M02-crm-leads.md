...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M02-01-quick-add-lead.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M02-03-leads-list.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M02-04-lead-detail.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M02-05-lead-import-wizard.md`; they are the specification.
**DONE WHEN:**
...
**Requirements (verbatim):** Verbatim rows live in `ux/briefs/SCR-M02-06-customer-merge.md`; they are the specification.
**DONE WHEN:**
...
The settings surface itself is M01's (SCR-M01-22, `ux/briefs/SCR-M01-22-capture-settings.md`); this task builds what it renders — the channel registry, each channel's true state, the toggle semantics, and the later-card facts for deferred channels.
