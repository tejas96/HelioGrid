...
BRANDS='MarketCode:packages/domain/ PackVersion:packages/domain/ MinorUnits:packages/domain/ BasisPoints:packages/domain/ ClockTime:packages/domain/ TenantScopedDb:packages/db/'
