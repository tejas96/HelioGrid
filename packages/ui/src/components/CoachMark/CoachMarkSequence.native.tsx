 ...
 * period for anchors that mount a frame or two late, then freezes for the run.
 *
 * `within` is web-only (see use-anchor-rect.native): a native mark is placed against the window.
 */
