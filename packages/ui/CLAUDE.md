# @heliogrid/ui — the 21-component _ds API (web)

## What lives here / what must never live here
- The 21 components (forms/data/feedback/navigation) + behavioral contracts. Ships
  SOURCE (`src/index.ts`); Next transpiles. Import ONLY from the index.
