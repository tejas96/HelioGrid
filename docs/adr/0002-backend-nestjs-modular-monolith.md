...
- Heavier baseline than Hono; DI indirection remains a real agent hazard — the four caveats above must be enforced in `apps/api/CLAUDE.md` §Local conventions, or we inherit the failure mode the research warned about.
