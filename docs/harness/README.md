...
Not wired in by default: `docs/17-ui-architecture-v2.md` keeps the apps free of `@heliogrid/ui`
...
4. `mkdir -p apps/web/app/render-check/fixtures`
   `cp docs/harness/render-check.page.tsx apps/web/app/render-check/page.tsx`
   `cp docs/harness/types.ts apps/web/app/render-check/types.ts`
   `cp docs/harness/fixtures/*.tsx apps/web/app/render-check/fixtures/`
