...
- **snoozed-dormant-excluded** — snoozed and dormant leads excluded from active-pipeline views, exactly as My Day excludes them (`docs/prd/modules/M13-dashboards-and-reporting.md` §M13.4 behavior detail).
