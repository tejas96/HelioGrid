...
Design at a realistic five-stop day — three booked visits plus two unplanned stops is the PRD's own example of a normal day (`docs/prd/modules/M09-field-workforce.md` §M09.4 behavior detail).
