...
- **MS11-05** (P0) — Share actions offer the customer-facing proposal link (`F5-33`) — not only the 3D-only link (`.25/.26` recorded divergence resolved by MS9-14).
