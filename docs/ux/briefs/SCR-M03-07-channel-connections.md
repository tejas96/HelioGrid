...
- **form-refused-missing-phone** — a lead-capture form without a required phone field cannot be connected; the connection flow refuses it and names the missing field (`M03-19`, owner ruling).
