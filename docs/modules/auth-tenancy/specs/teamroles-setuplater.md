...
| Sheet/modal shells | **composition** (no Sheet/Modal in the 21) — Radix Dialog under the hood per docs/10, styled per §2.1 | focus trap/restore mandatory |
...
unicode-in-text icons — docs/10 forbids unicode-as-icon; render `arrow-up-right` /
