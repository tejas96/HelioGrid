...
1. **SignUp is WEB-ONLY v1** — owners self-serve on web (D11); the field app's journey
   starts at Sign in / invite accept (mobile.md scope). RN shows sign-in + join only.
...
| 12 | Module QA attack + AI review (five lenses) + docs/13 rows + roadmap close | all | workflow.md | 1–11 | todo | |

## Module Definition of Done
workflow.md DoD per slice PLUS: all 14 mockups implemented or explicitly ruled ·
