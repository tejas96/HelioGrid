...
Status: draft · Origin mix: SRC-CODE-dominant + BRIEF (Sitting 7 rulings, 2026-08-05) · Depends on: MS4 (panel/inverter specs, topology, MLPE), MS6 (panels, segments, strings, structures), MS10 (BOM money path), F1 (pack: standards, ladders, design temperatures), F8 (assumed-vs-derived language), M05-12 (no gates in the studio)
