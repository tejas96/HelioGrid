...
to the owner for review. Doc-map statuses in `docs/prd/00-README.md` are set to
...
Date: 2026-08-04 · Gate scope: `docs/prd/registers/traceability.md` audited against every Task-2
extraction-ledger file (`docs/prd/_process/extraction/`) and every published PRD document ·
