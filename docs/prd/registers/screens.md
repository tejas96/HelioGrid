...
|---|---|---|---|---|---|---|---|---|---|
| SCR-SHELL-01 | **App Shell & Navigation** | P0 | 8 | `docs/ux/briefs/SCR-SHELL-01-app-shell.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-SHELL-01+App+Shell+-+Mobile.dc.html | `M02-crm-and-leads:shell-app-navigation`; `11-shell-and-platform:shell-top-bar`; `M13-dashboards-and-reporting:shell-home-switcher`; `M01-onboarding-and-tenant-config:shell-role-home`; ~~`F4-offline-and-sync:shell-sync-indicator`~~ *(proposal withdrawn 2026-08-07 — the global sync indicator was deleted with the offline/sync capability (owner ruling); nothing on this screen consumes it, and its tap target `SCR-SHELL-04` no longer exists. Kept struck because this register never deletes an entry. The proposing document was `F4-offline-and-sync.md`, itself deleted; the cell previously named its replacement `F4-data-integrity`, which never contained this element.)*; `F1-global-market-framework:shell-grievance-contact`; `M07-sales-execution:shell-user-presence` | 6aa711792fcb |
| SCR-SHELL-02 | **Global Search** | P0 | 2 | `docs/ux/briefs/SCR-SHELL-02-global-search.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-SHELL-02+Global+Search+-+Mobile.dc.html | — | 7ff544c90160 |
| SCR-SHELL-03 | **Notification Center** | P0 | 5 | `docs/ux/briefs/SCR-SHELL-03-notification-center.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-SHELL-03+Notification+Center+-+Mobile.dc.html | `M13-dashboards-and-reporting:shell-notification-center` | 26f380ed3770 |
| SCR-SHELL-06 | **Billing State Banner & Denial Sheets** | P0 | 6 | `docs/ux/briefs/SCR-SHELL-06-billing-state-banner.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-SHELL-06+Billing+State+Banner+-+Mobile.dc.html | — | d9b5be3a9274 |
...
| SCR | Screen | Tier | Rows | Brief | V | Status | Design link | Merged from | Brief reviewed |
|---|---|---|---|---|---|---|---|---|---|
| SCR-M01-01 | **Sign In** | P0 | 4 | `docs/ux/briefs/SCR-M01-01-sign-in.md` | V1 | shipped | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-01+Sign+In+-+Mobile.dc.html | `11-shell-and-platform:shell-sign-in` | b69a2de098b9 · code ok |
| SCR-M01-02 | **Company Signup** | P0 | 3 | `docs/ux/briefs/SCR-M01-02-company-signup.md` | V1 | shipped | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-02+Company+Signup+-+Mobile.dc.html | — | 42911f3dbb01 · code owed T-FPLAT-058 |
| SCR-M01-03 | **Onboarding — Language** | P0 | 1 | `docs/ux/briefs/SCR-M01-03-onboarding-language.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-03+Onboarding+Language+-+Mobile.dc.html | — | 0db656414cd5 |
| SCR-M01-04 | **Setup — What You Sell** | P0 | 1 | `docs/ux/briefs/SCR-M01-04-setup-what-you-sell.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-04+What+You+Sell+-+Mobile.dc.html | — | ca704bacd5d7 |
| SCR-M01-05 | **Business Profile** | P0 | 3 | `docs/ux/briefs/SCR-M01-05-business-profile.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-05+Business+Profile+-+Mobile.dc.html | — | 751fd4f3d8d6 |
| SCR-M01-06 | **Setup — You're Ready** | P0 | 1 | `docs/ux/briefs/SCR-M01-06-setup-ready.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-06+Youre+Ready+-+Mobile.dc.html | — | b50c31c76a41 |
| SCR-M01-07 | **Invite Teammate** | P0 | 2 | `docs/ux/briefs/SCR-M01-07-invite-teammate.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-07+Invite+Teammate+-+Mobile.dc.html | `F2-roles-and-permissions:invite-person` | 8fbbc3b9922b |
...
| SCR-M01-15 | **Catalog Settings** | P0 | 7 | `docs/ux/briefs/SCR-M01-15-catalog-settings.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-15+Catalog+Settings+-+Mobile.dc.html | — | 407a7675c052 |
| SCR-M01-16 | **Add Catalog Item** | P0 | 3 | `docs/ux/briefs/SCR-M01-16-add-catalog-item.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-16+Add+Catalog+Item+-+Mobile.dc.html | — | 74d4e3331f16 |
| SCR-M01-17 | **Catalog Import Wizard** | P0 | 1 | `docs/ux/briefs/SCR-M01-17-catalog-import-wizard.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-17+Catalog+Import+Wizard+-+Mobile.dc.html | — | 32e1526a04be |
| SCR-M01-18 | **Branding Settings** | P0 | 2 | `docs/ux/briefs/SCR-M01-18-branding-settings.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-18+Branding+Settings+-+Mobile.dc.html | `F7-design-language:shell-tenant-branding-settings` | edd44395abe1 |
| SCR-M01-19 | **Proposal Template Settings** | P0 | 2 | `docs/ux/briefs/SCR-M01-19-proposal-template-settings.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-19+Proposal+Template+-+Mobile.dc.html | — | 47ddff67dd30 |
| SCR-M01-20 | **Payment Terms Settings** | P0 | 1 | `docs/ux/briefs/SCR-M01-20-payment-terms-settings.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M01-20+Payment+Terms+-+Mobile.dc.html | — | 3e0f6c56dfb7 |
...
| SCR | Screen | Tier | Rows | Brief | V | Status | Design link | Merged from | Brief reviewed |
|---|---|---|---|---|---|---|---|---|---|
| SCR-M02-01 | **Quick Add Lead** | P0 | 9 | `docs/ux/briefs/SCR-M02-01-quick-add-lead.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M02-01+Quick+Add+Lead+-+Mobile.dc.html | — | 24d8edf2aef5 |
...
| SCR-M02-06 | **Customer Merge** | P0 | 3 | `docs/ux/briefs/SCR-M02-06-customer-merge.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M02-06+Customer+Merge+-+Mobile.dc.html | — | c5932b0edc3a |
...
| SCR-M08-02 | **Project Detail** | P0 | 7 | `docs/ux/briefs/SCR-M08-02-project-detail.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M08-02+Project+Detail+-+Mobile.dc.html | `M11-payments-and-collections:shell-project-money-block` | 6b560899018b |
...
| SCR | Screen | Tier | Rows | Brief | V | Status | Design link | Merged from | Brief reviewed |
|---|---|---|---|---|---|---|---|---|---|
| SCR-M12-01 | **Pricing Page** | P0 | 2 | `docs/ux/briefs/SCR-M12-01-pricing-page.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M12-01+Pricing+Page+-+Mobile.dc.html | — | d5f03e2f331d |
| SCR-M12-02 | **Billing Home** | P0 | 6 | `docs/ux/briefs/SCR-M12-02-billing-home.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M12-02+Billing+Home+-+Mobile.dc.html | `04-business-model:shell-billing` | 70f4ef87b2f4 |
| SCR-M12-03 | **Plan Selection & Conversion** | P0 | 5 | `docs/ux/briefs/SCR-M12-03-plan-selection.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M12-03+Plan+Selection+-+Mobile.dc.html | — | 76e5d8c98ea2 |
| SCR-M12-04 | **Usage** | P0 | 7 | `docs/ux/briefs/SCR-M12-04-usage-screen.md` | V1 | designed | https://claude.ai/design/p/2b5c5a1e-561a-4116-a710-63b85f669b70?file=SCR-M12-04+Usage+-+Mobile.dc.html | `04-business-model:shell-usage-screen` | d237a735322e |
...
| F4-04 | P0 | policy | policy | T-FPLAT-070 |
