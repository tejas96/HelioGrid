...
| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M01-01 | **Sign In** | P0 | 4 | `docs/ux/briefs/SCR-M01-01-sign-in.md` | V1 | pending | — | `11-shell-and-platform:shell-sign-in` |
| SCR-M01-02 | **Company Signup** | P0 | 3 | `docs/ux/briefs/SCR-M01-02-company-signup.md` | V1 | pending | — | — |
| SCR-M01-03 | **Onboarding — Language** | P0 | 1 | `docs/ux/briefs/SCR-M01-03-onboarding-language.md` | V1 | pending | — | — |
...
| SCR-M01-08 | **Invite Landing** | P0 | 1 | `docs/ux/briefs/SCR-M01-08-invite-landing.md` | V1 | pending | — | — |
