...
Extension point: one folder per module slice (authz/, auth/, branding/, tenancy/, calling/, certification/, commerce/, format/, market/, money/, pricing/, projects/, rails/, subsidy/, tax/ today); each
