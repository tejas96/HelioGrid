...
Extension point: one folder per module slice (authz/, auth/, tenancy/, calling/, certification/, commerce/, format/, market/, money/, pricing/, rails/, subsidy/, tax/ today); each
