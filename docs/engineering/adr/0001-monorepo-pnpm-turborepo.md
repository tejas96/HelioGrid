...
Date: 2026-07-24 · Updated: 2026-08-25 (removed cross-package TS project references) · 2026-09-25 (`tsc -p`, never `tsc -b`)
...
- **Single bundler-mode TS graph (no references)** — loses per-package incremental feedback and hard type boundaries.
