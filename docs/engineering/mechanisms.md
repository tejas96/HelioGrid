...
| M71 | Coverage thresholds land with the slice | vitest `thresholds` | PARTIAL · red 2026-09-06 | Two globs have a threshold, both at 100%: `packages/domain/src/format/**` and `packages/domain/src/market/**`. Every other covered path has none. |
