...
| M71 | Coverage thresholds land with the slice | vitest `thresholds` | PARTIAL · red 2026-09-06 | Six globs have a threshold, all at 100%: `calling/**`, `format/**`, `market/**`, `money/**`, `subsidy/**` and `tax/**` under `packages/domain/src/`. Every other covered path has none. |
