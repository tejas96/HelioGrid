...
- **Spec**: `docs/product-journey.md` (master, D1–D39 locked decisions), phase-3…10 prompt packs, DESIGN-SYSTEM.md ("Instrument": graphite+brass — visual identity since superseded 2026-07-24 by the vendored UX package `design/ds-source`, see docs/15 §3; the N1–N10 hard rules survive as interaction/a11y law), 85 UX mockups in `/Users/devtejas/Downloads/HelioGrid UX/` (production specs, 375/1440 viewports, seeded states).
