...
| **Studio census** | `prd/modules/M05-studio/studio-census.md`, adopted verbatim as the acceptance baseline for the design studio. The census never shrinks: nothing in it is dropped, downgraded or reworded away between this pass and the dedicated studio pass. | design spec §3.2, DD13 |
