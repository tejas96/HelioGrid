...
A screen splitting or merging during design updates THIS register first (see `ux/briefs/README.md`).
...
`prd/modules/M05-studio/06-step7-proposal.md` and is dispositioned in §3 like any other. Any
...
**`M02-66`**, **`M02-67`** (`prd/modules/M02-crm-and-leads.md` §M02.2 and §M02.5) and **`M09-71`**
(`prd/modules/M09-field-workforce.md` §M09.5). All three are P0 and all three are typed `mixed`,
...
counted from the live PRD: a row exists when it has a table row in `prd/foundations/*.md`,
`prd/modules/**/*.md` or `prd/0*.md` **and carries a tier**. The live PRD holds **1,660** such table
...
```bash
grep -c '^| SCR-.*| V1 | pending |' prd/registers/screens.md
```
...
|---|---|---|---|---|---|---|---|---|
| SCR-SHELL-01 | **App Shell & Navigation** | P0 | 8 | `ux/briefs/SCR-SHELL-01-app-shell.md` | V1 | pending | — | `M02-crm-and-leads:shell-app-navigation`; `11-shell-and-platform:shell-top-bar`; `M13-dashboards-and-reporting:shell-home-switcher`; `M01-onboarding-and-tenant-config:shell-role-home`; ~~`F4-offline-and-sync:shell-sync-indicator`~~ *(proposal withdrawn 2026-08-07 — the global sync indicator was deleted with the offline/sync capability, owner ruling `Q61`; nothing on this screen consumes it, and its tap target `SCR-SHELL-04` no longer exists. Kept struck because this register never deletes an entry. The proposing document was `F4-offline-and-sync.md`, itself deleted; the cell previously named its replacement `F4-data-integrity`, which never contained this element.)*; `F1-global-market-framework:shell-grievance-contact`; `M07-sales-execution:shell-user-presence` |
| SCR-SHELL-02 | **Global Search** | P0 | 2 | `ux/briefs/SCR-SHELL-02-global-search.md` | V1 | pending | — | — |
| SCR-SHELL-03 | **Notification Center** | P0 | 5 | `ux/briefs/SCR-SHELL-03-notification-center.md` | V1 | pending | — | `M13-dashboards-and-reporting:shell-notification-center` |
| SCR-SHELL-06 | **Billing State Banner & Denial Sheets** | P0 | 6 | `ux/briefs/SCR-SHELL-06-billing-state-banner.md` | V1 | pending | — | — |
| ~~SCR-SHELL-04~~ | ~~Sync Center~~ | — | 0 | *brief deleted* | — | **struck** | — | *Screen deleted 2026-08-07 with the offline/sync capability (owner ruling `Q61`). It existed for `F4-23`, the per-item sync centre — struck in §3 — and its brief `ux/briefs/SCR-SHELL-04-sync-center.md` was deleted with it. The per-item retry it hosted survives only for photographs and only on `SCR-M04-07` (`F4-21`, `M04-55`). Restored as a struck entry 2026-08-15: §3 records every deleted requirement, and §2 must record every deleted screen for the same reason — a screen that vanishes without a mark cannot be audited. Not counted in the 150.* |
| ~~SCR-SHELL-05~~ | ~~Update Required~~ | — | 0 | *brief deleted* | — | **struck** | — | *Screen deleted 2026-08-07 with the offline/sync capability (owner ruling `Q61`). It existed only for `F4-35` ("an application too old to sync still reads") — struck in §3 — and its brief `ux/briefs/SCR-SHELL-05-update-required.md` was deleted with it. **What a too-old client should show is now unstated anywhere in the suite**, recorded as OPEN question `Q65` in `registers/open-questions.md`; nothing here re-instates it. Restored as a struck entry 2026-08-15. Not counted in the 150.* |

### M01 · Onboarding & tenant config

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M01-01 | **Sign In** | P0 | 4 | `ux/briefs/SCR-M01-01-sign-in.md` | V1 | pending | — | `11-shell-and-platform:shell-sign-in` |
| SCR-M01-02 | **Company Signup** | P0 | 3 | `ux/briefs/SCR-M01-02-company-signup.md` | V1 | pending | — | — |
| SCR-M01-03 | **Onboarding — Language** | P0 | 1 | `ux/briefs/SCR-M01-03-onboarding-language.md` | V1 | pending | — | — |
| SCR-M01-04 | **Setup — What You Sell** | P0 | 1 | `ux/briefs/SCR-M01-04-setup-what-you-sell.md` | V1 | pending | — | — |
| SCR-M01-05 | **Business Profile** | P0 | 3 | `ux/briefs/SCR-M01-05-business-profile.md` | V1 | pending | — | — |
| SCR-M01-06 | **Setup — You're Ready** | P0 | 1 | `ux/briefs/SCR-M01-06-setup-ready.md` | V1 | pending | — | — |
| SCR-M01-07 | **Invite Teammate** | P0 | 2 | `ux/briefs/SCR-M01-07-invite-teammate.md` | V1 | pending | — | `F2-roles-and-permissions:invite-person` |
| SCR-M01-08 | **Invite Landing** | P0 | 1 | `ux/briefs/SCR-M01-08-invite-landing.md` | V1 | pending | — | — |
| SCR-M01-09 | **First-Run Profile** | P0 | 1 | `ux/briefs/SCR-M01-09-first-run-profile.md` | V1 | pending | — | — |
| SCR-M01-10 | **Role Explainer** | P1 | 1 | `ux/briefs/SCR-M01-10-role-explainer.md` | V1 | pending | — | — |
| SCR-M01-11 | **Profile & Preferences** | P0 | 4 | `ux/briefs/SCR-M01-11-profile-preferences.md` | V1 | pending | — | `F7-design-language:shell-app-settings`; `F6-notifications-and-search:notification-preferences` |
| SCR-M01-12 | **Team** | P0 | 3 | `ux/briefs/SCR-M01-12-team.md` | V1 | pending | — | `F2-roles-and-permissions:team` |
| SCR-M01-13 | **Assign Roles** | P0 | 1 | `ux/briefs/SCR-M01-13-assign-roles.md` | V1 | pending | — | — |
| SCR-M01-14 | **Roles Reference** | P0 | 1 | `ux/briefs/SCR-M01-14-roles-reference.md` | V1 | pending | — | — |
| SCR-M01-15 | **Catalog Settings** | P0 | 7 | `ux/briefs/SCR-M01-15-catalog-settings.md` | V1 | pending | — | — |
| SCR-M01-16 | **Add Catalog Item** | P0 | 3 | `ux/briefs/SCR-M01-16-add-catalog-item.md` | V1 | pending | — | — |
| SCR-M01-17 | **Catalog Import Wizard** | P0 | 1 | `ux/briefs/SCR-M01-17-catalog-import-wizard.md` | V1 | pending | — | — |
| SCR-M01-18 | **Branding Settings** | P0 | 2 | `ux/briefs/SCR-M01-18-branding-settings.md` | V1 | pending | — | `F7-design-language:shell-tenant-branding-settings` |
| SCR-M01-19 | **Proposal Template Settings** | P0 | 2 | `ux/briefs/SCR-M01-19-proposal-template-settings.md` | V1 | pending | — | — |
| SCR-M01-20 | **Payment Terms Settings** | P0 | 1 | `ux/briefs/SCR-M01-20-payment-terms-settings.md` | V1 | pending | — | — |
| SCR-M01-21 | **Message Template Settings** | P0 | 1 | `ux/briefs/SCR-M01-21-message-template-settings.md` | V2 | pending | — | — |
| SCR-M01-22 | **Capture Settings** | P0 | 4 | `ux/briefs/SCR-M01-22-capture-settings.md` | V2 | pending | — | `M02-crm-and-leads:capture-settings` |
| SCR-M01-23 | **Locale Defaults** | P1 | 1 | `ux/briefs/SCR-M01-23-locale-defaults.md` | V2 | pending | — | — |
| SCR-M01-24 | **Integration Credentials** | P0 | 1 | `ux/briefs/SCR-M01-24-integration-credentials.md` | V2 | pending | — | — |

### M02 · CRM & leads

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M02-01 | **Quick Add Lead** | P0 | 9 | `ux/briefs/SCR-M02-01-quick-add-lead.md` | V1 | pending | — | — |
| SCR-M02-02 | **Lead Inbox** | P0 | 8 | `ux/briefs/SCR-M02-02-lead-inbox.md` | V1 | pending | — | — |
| SCR-M02-03 | **Leads List** | P0 | 3 | `ux/briefs/SCR-M02-03-leads-list.md` | V1 | pending | — | — |
| SCR-M02-04 | **Lead Detail** | P0 | 22 | `ux/briefs/SCR-M02-04-lead-detail.md` | V1 | pending | — | `M06-proposals:shell-lead-detail`; `M09-field-workforce:shell-lead-detail`; `M03-marketing:shell-lead-consent-trail`; `M06-proposals:shell-customer-record` |
| SCR-M02-05 | **Lead Import Wizard** | P0 | 8 | `ux/briefs/SCR-M02-05-lead-import-wizard.md` | V1 | pending | — | — |
| SCR-M02-06 | **Customer Merge** | P0 | 3 | `ux/briefs/SCR-M02-06-customer-merge.md` | V1 | pending | — | — |

### M03 · Marketing

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M03-01 | **Campaign List (Campaigns Home)** | P0 | 4 | `ux/briefs/SCR-M03-01-campaign-list.md` | V2 | pending | — | `02-personas:shell-campaigns-and-captures`; `M13-dashboards-and-reporting:campaigns-home` |
| SCR-M03-02 | **Campaign Builder — Audience** | P0 | 2 | `ux/briefs/SCR-M03-02-campaign-builder-audience.md` | V2 | pending | — | — |
| SCR-M03-03 | **Campaign Builder — Content** | P0 | 3 | `ux/briefs/SCR-M03-03-campaign-builder-content.md` | V2 | pending | — | — |
| SCR-M03-04 | **Campaign Builder — Review & Schedule** | P0 | 4 | `ux/briefs/SCR-M03-04-campaign-builder-review.md` | V2 | pending | — | — |
| SCR-M03-05 | **Campaign Detail** | P0 | 4 | `ux/briefs/SCR-M03-05-campaign-detail.md` | V2 | pending | — | — |
| SCR-M03-06 | **Campaign Performance** | P0 | 7 | `ux/briefs/SCR-M03-06-campaign-performance.md` | V2 | pending | — | — |
| SCR-M03-07 | **Channel Connections** | P0 | 3 | `ux/briefs/SCR-M03-07-channel-connections.md` | V2 | pending | — | — |
| SCR-M03-08 | **Channel Health** | P0 | 3 | `ux/briefs/SCR-M03-08-channel-health.md` | V2 | pending | — | — |
| SCR-M03-09 | **Campaign Templates** | P0 | 1 | `ux/briefs/SCR-M03-09-campaign-templates.md` | V2 | pending | — | — |
| SCR-M03-10 | **Website Enquiry Form** | P0 | 1 | `ux/briefs/SCR-M03-10-website-enquiry-form.md` | V2 | pending | — | — |

### M04 · Survey

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M04-01 | **Survey Mode Chooser** | P0 | 1 | `ux/briefs/SCR-M04-01-survey-mode-chooser.md` | V2 | pending | — | — |
| SCR-M04-02 | **Remote Survey — Address Entry** | P0 | 3 | `ux/briefs/SCR-M04-02-remote-address-entry.md` | V2 | pending | — | — |
| SCR-M04-03 | **Remote Roof Review** | P0 | 9 | `ux/briefs/SCR-M04-03-remote-roof-review.md` | V2 | pending | — | — |
| SCR-M04-04 | **Coverage Failure** | P0 | 1 | `ux/briefs/SCR-M04-04-coverage-failure.md` | V2 | pending | — | — |
| SCR-M04-05 | **Gaps to Fill** | P0 | 4 | `ux/briefs/SCR-M04-05-gaps-to-fill.md` | V2 | pending | — | — |
| SCR-M04-06 | **My Visits Today** | P0 | 5 | `ux/briefs/SCR-M04-06-my-visits-today.md` | V2 | pending | — | `02-personas:shell-todays-site-visits`; `M13-dashboards-and-reporting:todays-visits` |
| SCR-M04-07 | **Guided Capture** | P0 | 9 | `ux/briefs/SCR-M04-07-guided-capture.md` | V2 | pending | — | — |
| SCR-M04-08 | **Shading Capture Sketch** | P0 | 1 | `ux/briefs/SCR-M04-08-shading-capture-sketch.md` | V2 | pending | — | — |
| SCR-M04-09 | **Review & Submit** | P0 | 4 | `ux/briefs/SCR-M04-09-review-submit.md` | V2 | pending | — | — |
| SCR-M04-10 | **Survey Detail (Hand-off Brief)** | P0 | 5 | `ux/briefs/SCR-M04-10-survey-detail.md` | V2 | pending | — | — |
...
| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-MS-01 | **Design List** | P0 | 8 | `ux/briefs/SCR-MS-01-design-list.md` | V1 | pending | — | `11-shell-and-platform:design-list` |
| SCR-MS-02 | **Design Queue (Designer Home)** | P0 | 3 | `ux/briefs/SCR-MS-02-design-queue.md` | V1 | pending | — | `02-personas:shell-designs-awaiting-work` |
| SCR-MS-03 | **Studio Shell (Wizard Frame)** | P0 | 18 | `ux/briefs/SCR-MS-03-studio-shell.md` | V1 | pending | — | `11-shell-and-platform:studio-wizard-frame` |
| SCR-MS-04 | **Studio Step 1 — Site Setup** | P0 | 28 | `ux/briefs/SCR-MS-04-step1-site-setup.md` | V1 | pending | — | `M05-design-studio:step1-site-setup` |
| SCR-MS-05 | **Studio Step 2 — Roof** | P0 | 41 | `ux/briefs/SCR-MS-05-step2-roof.md` | V1 | pending | — | `M05-design-studio:step2-roof-drawing` |
| SCR-MS-06 | **Studio Step 3 — Obstructions** | P0 | 35 | `ux/briefs/SCR-MS-06-step3-obstructions.md` | V1 | pending | — | `M05-design-studio:step3-obstructions` |
| SCR-MS-07 | **Studio Step 4 — Components** | P0 | 33 | `ux/briefs/SCR-MS-07-step4-components.md` | V1 | pending | — | `M05-design-studio:step4-components` |
| SCR-MS-08 | **Studio Step 6 — Layout Editor** | P0 | 37 | `ux/briefs/SCR-MS-08-step6-layout-editor.md` | V1 | pending | — | `M05-design-studio:step5-6-panel-layout` |
| SCR-MS-09 | **Studio 3D Scene** | P0 | 22 | `ux/briefs/SCR-MS-09-3d-scene.md` | V1 | pending | — | `M05-design-studio:3d-view`; `03-step3-obstructions:studio-3d-scene` |
| SCR-MS-10 | **Studio Step 7 — Proposal** | P0 | 25 | `ux/briefs/SCR-MS-10-step7-proposal.md` | V1 | pending | — | `M05-design-studio:step7-captures-readiness` |
| SCR-MS-11 | **Studio Step 8 — SLD & Drawings** | P0 | 28 | `ux/briefs/SCR-MS-11-step8-sld.md` | V1 | pending | — | `M05-design-studio:step8-sld-drawings` |
| SCR-MS-12 | **Studio Step 9 — Bill of Materials** | P0 | 24 | `ux/briefs/SCR-MS-12-step9-bom.md` | V1 | pending | — | `M05-design-studio:step9-bom-pricing` |
| SCR-MS-13 | **Studio Done** | P0 | 10 | `ux/briefs/SCR-MS-13-done-step.md` | V1 | pending | — | `M05-design-studio:studio-done` |
| SCR-MS-14 | **Variant Compare** | P0 | 1 | `ux/briefs/SCR-MS-14-variant-compare.md` | V1 | pending | — | — |
| SCR-MS-15 | **Sign-off Queue** | P0 | 2 | `ux/briefs/SCR-MS-15-signoff-queue.md` | V1 | pending | — | `M05-design-studio:signoff-queue` |
| SCR-MS-16 | **Sign-off Review** | P0 | 4 | `ux/briefs/SCR-MS-16-signoff-review.md` | V1 | pending | — | `M05-design-studio:design-review` |
| SCR-MS-17 | **Installation Work Order** | P0 | 11 | `ux/briefs/SCR-MS-17-installation-work-order.md` | V1 | pending | — | `M05-design-studio:installation-plan` |
| SCR-MS-18 | **Design System Reference** | P1 | 1 | `ux/briefs/SCR-MS-18-design-system-reference.md` | V1 | pending | — | — |

### Customer link (F5)

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-F5-01 | **Customer Link — Proposal** | P0 | 25 | `ux/briefs/SCR-F5-01-link-proposal.md` | V1 | pending | — | `08-customer-surfaces:proposal-share-page` |
| SCR-F5-02 | **Customer Link — Progress** | P0 | 16 | `ux/briefs/SCR-F5-02-link-progress.md` | V1 | pending | — | `M08-projects:shell-customer-progress-link`; `M11-payments-and-collections:shell-customer-receipts`; `M09-field-workforce:shell-customer-link` |
| SCR-F5-03 | **Customer Link — Handover Pack** | P0 | 9 | `ux/briefs/SCR-F5-03-link-handover.md` | V1 | pending | — | — |
| SCR-F5-04 | **Link Failure Page** | P0 | 2 | `ux/briefs/SCR-F5-04-link-failure.md` | V1 | pending | — | — |
| SCR-F5-05 | **Customer 3D View** | P0 | 2 | `ux/briefs/SCR-F5-05-customer-3d-view.md` | V1 | pending | — | `05-step6-editor:customer-proposal-3d-view` |

### M06 · Proposals

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M06-01 | **Proposal Entry** | P0 | 3 | `ux/briefs/SCR-M06-01-proposal-entry.md` | V1 | pending | — | — |
| SCR-M06-02 | **Proposal Builder** | P0 | 5 | `ux/briefs/SCR-M06-02-proposal-builder.md` | V1 | pending | — | — |
| SCR-M06-03 | **Builder Step 1 — Company** | P0 | 2 | `ux/briefs/SCR-M06-03-builder-step-1-company.md` | V1 | pending | — | — |
| SCR-M06-04 | **Builder Step 2 — Achievements** | P0 | 1 | `ux/briefs/SCR-M06-04-builder-step-2-achievements.md` | V1 | pending | — | — |
| SCR-M06-05 | **Builder Step 3 — Solar System Setup** | P0 | 4 | `ux/briefs/SCR-M06-05-builder-step-3-system-setup.md` | V1 | pending | — | — |
| SCR-M06-06 | **Builder Step 4 — Performance Metrics** | P0 | 1 | `ux/briefs/SCR-M06-06-builder-step-4-performance.md` | V1 | pending | — | — |
| SCR-M06-07 | **Builder Step 5 — Financial Data** | P0 | 1 | `ux/briefs/SCR-M06-07-builder-step-5-financial.md` | V1 | pending | — | — |
| SCR-M06-08 | **Builder Step 6 — Project Timeline** | P0 | 1 | `ux/briefs/SCR-M06-08-builder-step-6-timeline.md` | V1 | pending | — | — |
| SCR-M06-09 | **Builder Step 7 — Payment Terms** | P0 | 1 | `ux/briefs/SCR-M06-09-builder-step-7-payment-terms.md` | V1 | pending | — | — |
| SCR-M06-10 | **Builder Step 8 — Components** | P0 | 5 | `ux/briefs/SCR-M06-10-builder-step-8-components.md` | V1 | pending | — | — |
| SCR-M06-11 | **Builder Step 9 — Terms & Conditions** | P0 | 1 | `ux/briefs/SCR-M06-11-builder-step-9-terms.md` | V1 | pending | — | — |
| SCR-M06-12 | **Builder Step 10 — Client Details** | P0 | 1 | `ux/briefs/SCR-M06-12-builder-step-10-client-details.md` | V1 | pending | — | — |
| SCR-M06-13 | **Builder Step 11 — Bank Details** | P0 | 1 | `ux/briefs/SCR-M06-13-builder-step-11-bank-details.md` | V1 | pending | — | — |
| SCR-M06-14 | **BOM Detail** | P0 | 1 | `ux/briefs/SCR-M06-14-bom-detail.md` | V1 | pending | — | — |
| SCR-M06-15 | **Proposal Preview** | P0 | 1 | `ux/briefs/SCR-M06-15-proposal-preview.md` | V1 | pending | — | — |
| SCR-M06-16 | **Proposal Versions** | P0 | 1 | `ux/briefs/SCR-M06-16-proposal-versions.md` | V1 | pending | — | — |
| SCR-M06-17 | **Proposal Document** | P0 | 20 | `ux/briefs/SCR-M06-17-proposal-document.md` | V1 | pending | — | `08-customer-surfaces:proposal-document` |
| SCR-M06-18 | **Proposal Detail** | P0 | 6 | `ux/briefs/SCR-M06-18-proposal-detail.md` | V1 | pending | — | — |
| SCR-M06-19 | **Proposal List** | P0 | 2 | `ux/briefs/SCR-M06-19-proposal-list.md` | V1 | pending | — | — |
| SCR-M06-20 | **Deal Link Manager** | P0 | 1 | `ux/briefs/SCR-M06-20-deal-link-manager.md` | V1 | pending | — | — |

### M07 · Sales execution

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M07-01 | **My Day** | P0 | 7 | `ux/briefs/SCR-M07-01-my-day.md` | V1 | pending | — | `02-personas:shell-my-day`; `M13-dashboards-and-reporting:my-day` |
| SCR-M07-02 | **Mark Won** | P0 | 1 | `ux/briefs/SCR-M07-02-mark-won.md` | V1 | pending | — | — |
| SCR-M07-03 | **Mark Lost** | P0 | 1 | `ux/briefs/SCR-M07-03-mark-lost.md` | V1 | pending | — | — |
| SCR-M07-04 | **Reopen Lead** | P0 | 1 | `ux/briefs/SCR-M07-04-reopen-lead.md` | V1 | pending | — | — |
| SCR-M07-05 | **Agent Setup & Settings** | P0 | 7 | `ux/briefs/SCR-M07-05-agent-setup-settings.md` | V1 | pending | — | `M01-onboarding-and-tenant-config:shell-agent-voice-settings` |
| SCR-M07-06 | **Calling Window** | P0 | 1 | `ux/briefs/SCR-M07-06-calling-window.md` | V1 | pending | — | — |
| SCR-M07-07 | **Test Agent** | P0 | 1 | `ux/briefs/SCR-M07-07-test-agent.md` | V2 | pending | — | — |
| SCR-M07-08 | **Agent Config History** | P0 | 1 | `ux/briefs/SCR-M07-08-agent-config-history.md` | V2 | pending | — | — |
| SCR-M07-09 | **Knowledge Base** | P0 | 3 | `ux/briefs/SCR-M07-09-knowledge-base.md` | V1 | pending | — | — |
| SCR-M07-10 | **Unanswered Questions** | P0 | 3 | `ux/briefs/SCR-M07-10-unanswered-questions.md` | V2 | pending | — | `M13-dashboards-and-reporting:agent-unanswered-questions` |
| SCR-M07-11 | **Corrections Review Queue** | P0 | 1 | `ux/briefs/SCR-M07-11-corrections-review-queue.md` | V2 | pending | — | — |
| SCR-M07-12 | **Agent Call Queue** | P0 | 5 | `ux/briefs/SCR-M07-12-agent-call-queue.md` | V1 | pending | — | — |
| SCR-M07-13 | **Call Record Detail** | P0 | 2 | `ux/briefs/SCR-M07-13-call-record-detail.md` | V1 | pending | — | — |
| SCR-M07-14 | **Escalations** | P0 | 1 | `ux/briefs/SCR-M07-14-escalations.md` | V1 | pending | — | — |
| SCR-M07-15 | **Routing Rules Editor** | P0 | 1 | `ux/briefs/SCR-M07-15-routing-rules-editor.md` | V2 | pending | — | — |
| SCR-M07-16 | **IVR Flow Editor** | P0 | 1 | `ux/briefs/SCR-M07-16-ivr-flow-editor.md` | V2 | pending | — | — |
| SCR-M07-17 | **Number Provisioning Wizard** | P0 | 3 | `ux/briefs/SCR-M07-17-number-provisioning-wizard.md` | V2 | pending | — | — |
| SCR-M07-18 | **Agent Performance** | P0 | 8 | `ux/briefs/SCR-M07-18-agent-performance.md` | V2 | pending | — | `M13-dashboards-and-reporting:agent-performance-dashboard`; `M13-dashboards-and-reporting:agent-per-rep-view` |
| SCR-M07-19 | **Call Log** | P0 | 2 | `ux/briefs/SCR-M07-19-call-log.md` | V1 | pending | — | `M13-dashboards-and-reporting:agent-call-log` |
| SCR-M07-20 | **Agent Usage** | P0 | 2 | `ux/briefs/SCR-M07-20-agent-usage.md` | V2 | pending | — | `M13-dashboards-and-reporting:agent-usage-report` |

### M08 · Projects

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M08-01 | **Project Board** | P0 | 8 | `ux/briefs/SCR-M08-01-project-board.md` | V1 | pending | — | `02-personas:shell-projects-board`; `M13-dashboards-and-reporting:projects-home`; `M08-projects:shell-portfolio-dashboard` |
| SCR-M08-02 | **Project Detail** | P0 | 7 | `ux/briefs/SCR-M08-02-project-detail.md` | V1 | pending | — | `M11-payments-and-collections:shell-project-money-block` |
| SCR-M08-03 | **Document Checklist** | P0 | 2 | `ux/briefs/SCR-M08-03-document-checklist.md` | V1 | pending | — | — |
| SCR-M08-04 | **Installation Checklist** | P0 | 3 | `ux/briefs/SCR-M08-04-installation-checklist.md` | V1 | pending | — | `F2-roles-and-permissions:installation-checklist` |
| SCR-M08-05 | **Installer Job Home** | P0 | 3 | `ux/briefs/SCR-M08-05-installer-job-home.md` | V1 | pending | — | `02-personas:shell-todays-installation`; `M13-dashboards-and-reporting:todays-installation` |
| SCR-M08-06 | **Handover Flow** | P0 | 2 | `ux/briefs/SCR-M08-06-handover-flow.md` | V1 | pending | — | — |

### M09 · Field workforce

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M09-01 | **Tracking Settings** | P0 | 7 | `ux/briefs/SCR-M09-01-tracking-settings.md` | V2 | pending | — | — |
| SCR-M09-02 | **My Day (Route)** | P0 | 15 | `ux/briefs/SCR-M09-02-my-day-route.md` | V2 | pending | — | `02-personas:shell-my-route-today`; `M13-dashboards-and-reporting:todays-route` |
| SCR-M09-03 | **Visit Stop Detail** | P0 | 2 | `ux/briefs/SCR-M09-03-visit-stop-detail.md` | V2 | pending | — | — |
| SCR-M09-04 | **Team Field Day** | P0 | 6 | `ux/briefs/SCR-M09-04-team-field-day.md` | V2 | pending | — | — |
| SCR-M09-05 | **Activity Timeline** | P0 | 4 | `ux/briefs/SCR-M09-05-activity-timeline.md` | V2 | pending | — | — |
| SCR-M09-06 | **Day Playback** | P0 | 2 | `ux/briefs/SCR-M09-06-day-playback.md` | V2 | pending | — | — |
| SCR-M09-07 | **Site Geofence** | P0 | 2 | `ux/briefs/SCR-M09-07-site-geofence.md` | V2 | pending | — | — |

### M10 · HR lite

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M10-01 | **People Today Queue** | P0 | 10 | `ux/briefs/SCR-M10-01-people-today-queue.md` | V2 | pending | — | `02-personas:shell-people-today`; `M13-dashboards-and-reporting:people-today-home` |
| SCR-M10-02 | **People List** | P0 | 3 | `ux/briefs/SCR-M10-02-people-list.md` | V2 | pending | — | — |
| SCR-M10-03 | **Employee Record** | P0 | 5 | `ux/briefs/SCR-M10-03-employee-record.md` | V2 | pending | — | — |
| SCR-M10-04 | **Offboard Sweep** | P0 | 4 | `ux/briefs/SCR-M10-04-offboard-sweep.md` | V2 | pending | — | — |
| SCR-M10-05 | **Attendance Register** | P0 | 4 | `ux/briefs/SCR-M10-05-attendance-register.md` | V2 | pending | — | — |
| SCR-M10-06 | **Leave Request** | P0 | 1 | `ux/briefs/SCR-M10-06-leave-request.md` | V2 | pending | — | — |
| SCR-M10-07 | **Team Structure** | P0 | 1 | `ux/briefs/SCR-M10-07-team-structure.md` | V2 | pending | — | — |

### M11 · Payments & collections

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M11-01 | **Finance Home (Money Due)** | P0 | 3 | `ux/briefs/SCR-M11-01-finance-home.md` | V1 | pending | — | `02-personas:shell-money-due`; `M13-dashboards-and-reporting:money-due` |
| SCR-M11-02 | **Payments Ledger** | P0 | 15 | `ux/briefs/SCR-M11-02-payments-ledger.md` | V1 | pending | — | `M08-projects:shell-payments-screen` |
| SCR-M11-03 | **Record Payment** | P0 | 7 | `ux/briefs/SCR-M11-03-record-payment.md` | V1 | pending | — | — |
| SCR-M11-04 | **Collections Settings** | P0 | 2 | `ux/briefs/SCR-M11-04-collections-settings.md` | V1 | pending | — | — |

### M12 · Platform billing

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M12-01 | **Pricing Page** | P0 | 2 | `ux/briefs/SCR-M12-01-pricing-page.md` | V1 | pending | — | — |
| SCR-M12-02 | **Billing Home** | P0 | 6 | `ux/briefs/SCR-M12-02-billing-home.md` | V1 | pending | — | `04-business-model:shell-billing` |
| SCR-M12-03 | **Plan Selection & Conversion** | P0 | 5 | `ux/briefs/SCR-M12-03-plan-selection.md` | V1 | pending | — | — |
| SCR-M12-04 | **Usage** | P0 | 7 | `ux/briefs/SCR-M12-04-usage-screen.md` | V1 | pending | — | `04-business-model:shell-usage-screen` |

### M13 · Dashboards & reporting

| SCR | Screen | Tier | Rows | Brief | V | UX status | Design link | Merged from |
|---|---|---|---|---|---|---|---|---|
| SCR-M13-01 | **Owner Dashboard** | P0 | 11 | `ux/briefs/SCR-M13-01-owner-dashboard.md` | V1 | pending | — | — |
| SCR-M13-02 | **Pipeline Dashboard (Rep's own step-back)** | P0 | 1 | `ux/briefs/SCR-M13-02-pipeline-dashboard.md` | V2 | pending | — | `02-personas:shell-pipeline-dashboard` |
| SCR-M13-03 | **Operations Home** | P0 | 4 | `ux/briefs/SCR-M13-03-operations-home.md` | V2 | pending | — | `02-personas:shell-blockers-by-party` |
| SCR-M13-04 | **Pipeline Funnel** | P0 | 3 | `ux/briefs/SCR-M13-04-pipeline-funnel.md` | V2 | pending | — | — |
| SCR-M13-05 | **Win/Loss Analytics** | P0 | 2 | `ux/briefs/SCR-M13-05-win-loss-analytics.md` | V2 | pending | — | — |
...
task id(s) in `tasks/` (backfilled by the generator once tasks exist).
...
| OV-02 | P0 | context | context → informative; global framing carried by F1 | realized-by: informative; global framing carried by `prd/foundations/F1-global-market-framework.md` |
| OV-03 | P0 | context | context → M05-design-studio | realized-by: `prd/modules/M05-design-studio.md` |
| OV-04 | P0 | policy | policy | LAW |
| OV-05 | P0 | context | context → 04-business-model.md | realized-by: `prd/04-business-model.md` |
| OV-06 | P0 | policy | policy | LAW |
| OV-07 | P1 | policy | policy | LAW |
| OV-08 | P0 | policy | policy | LAW |
| OV-09 | P0 | policy | policy | LAW |
| OV-10 | P0 | context | context → M07, M06, F5, M13 | realized-by: `prd/modules/M07-sales-execution.md`, `prd/modules/M06-proposals.md`, `prd/foundations/F5-customer-link.md`, `prd/modules/M13-dashboards-and-reporting.md` |
| OV-11 | P0 | context | context → M13-dashboards-and-reporting | realized-by: `prd/modules/M13-dashboards-and-reporting.md` |
| OV-12 | P0 | context | context → informative (design goal in every module) | realized-by: informative (a design goal in every module) |
| OV-13 | P1 | context | context → M07-sales-execution | realized-by: `prd/modules/M07-sales-execution.md` |
| OV-14 | P1 | context | context → M09-field-workforce | realized-by: `prd/modules/M09-field-workforce.md` |
| OV-15 | P0 | context | context → M06, M05, F8 | realized-by: `prd/modules/M06-proposals.md`, `prd/modules/M05-design-studio.md`, `prd/foundations/F8-data-honesty.md` |
| OV-16 | P0 | context | context → F6 (one search), all modules | realized-by: `prd/foundations/F6-notifications-and-search.md` (one search) and all modules |
| OV-17 | P0 | context | context → 04-business-model.md | realized-by: `prd/04-business-model.md` |
| OV-18 | P1 | context | context → 04-business-model.md, M05 | realized-by: `prd/04-business-model.md`, `prd/modules/M05-design-studio.md` |
| OV-19 | P0 | context | context → F1-global-market-framework | realized-by: `prd/foundations/F1-global-market-framework.md` |
| OV-20 | P0 | context | context → 04-business-model.md | realized-by: `prd/04-business-model.md` |
...
| OV-37 | P0 | context | context → M07-sales-execution, F1-global-market-framework | realized-by: `prd/modules/M07-sales-execution.md`, `prd/foundations/F1-global-market-framework.md` |
| OV-38 | P0 | context | context → F8-data-honesty | realized-by: `prd/foundations/F8-data-honesty.md` |
...
| OV-40 | P0 | context | context → F3-localization, F7-design-language, F1 (grouping) | realized-by: `prd/foundations/F3-localization.md`, `prd/foundations/F7-design-language.md`, `prd/foundations/F1-global-market-framework.md` (grouping) |
| OV-41 | P0 | context | context → M01-onboarding-and-tenant-config | realized-by: `prd/modules/M01-onboarding-and-tenant-config.md` |
| OV-42 | P0 | context | context → 04-business-model.md | realized-by: `prd/04-business-model.md` |
...
| PS-06 | P0 | context | context → F2 §EPC Owner | realized-by: `prd/foundations/F2-roles-and-permissions.md` §EPC Owner |
| PS-07 | P0 | screen | SCR-M13-01 | T-M13-002 |
| PS-08 | P0 | context | context → F2 §Sales Manager | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Sales Manager |
| PS-09 | P0 | screen | SCR-M13-01 | T-M13-002 |
| PS-10 | P0 | context | context → F2 §Sales Executive | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Sales Executive |
| PS-11 | P0 | screen | SCR-M07-01 | T-M07-001 |
| PS-12 | P0 | context | context → F2 §Survey Engineer; M04-survey | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Survey Engineer · `prd/modules/M04-survey.md` |
| PS-13 | P0 | screen | SCR-M04-06 | T-M04-006 |
| PS-14 | P0 | policy | policy | LAW |
| PS-15 | P0 | context | context → F2 §Design Engineer; M05-design-studio | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Design Engineer · `prd/modules/M05-design-studio.md` |
| PS-16 | P0 | screen | SCR-MS-02 | T-MS-375 |
| PS-17 | P0 | policy | policy | LAW |
| PS-18 | P0 | screen | SCR-MS-02 | T-MS-375 |
| PS-19 | P0 | policy | policy | LAW |
| PS-20 | P0 | context | context → F2 §Project Manager; M08-projects | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Project Manager · `prd/modules/M08-projects.md` |
| PS-21 | P0 | screen | SCR-M08-01 | T-M08-001 |
| PS-22 | P0 | context | context → F2 §Field Technician; M09-field-workforce | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Field Technician · `prd/modules/M09-field-workforce.md` |
| PS-23 | P1 | screen | SCR-M09-02 | T-M09-002 |
| ~~PS-24~~ | — | **excluded** | *Row deleted 2026-08-07 with the offline/sync capability (owner ruling `Q61`) — swept for the company it kept rather than for what it said, and `prd/02-personas.md` carries no strike note where it stood, between the surviving `PS-23` and `PS-25`. The Field Technician platform law it held, "mobile sessions are long-lived", was never a connectivity rule and is live with a concrete value at `M01-07`, built by `T-M01-025` (recorded in `tasks/F-core.md`). Nothing is re-instated here.* | — |
| PS-25 | P0 | context | context → F2 §Installation Team Member; M08-projects | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Installation Team Member · `prd/modules/M08-projects.md` |
| PS-26 | P1 | screen | SCR-M08-05 | T-M08-005 |
| PS-27 | P0 | policy | policy | LAW |
| PS-28 | P1 | policy | policy | LAW |
| PS-29 | P0 | context | context → F2 §HR/Admin; M10-hr-lite | realized-by: `prd/foundations/F2-roles-and-permissions.md` §HR/Admin · `prd/modules/M10-hr-lite.md` |
| PS-30 | P2 | screen | SCR-M10-01 | T-M10-001 |
| PS-31 | P0 | context | context → F2 §Finance; M11-payments-and-collections | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Finance · `prd/modules/M11-payments-and-collections.md` |
| PS-32 | P1 | screen | SCR-M11-01 | T-M11-001 |
| PS-33 | P0 | context | context → F2 §Operations; M08, M09 | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Operations · `prd/modules/M08-projects.md`, `prd/modules/M09-field-workforce.md` |
| PS-34 | P1 | screen | SCR-M13-03 | T-M13-003 |
| PS-35 | P0 | context | context → F2 §Marketing; M03-marketing | realized-by: `prd/foundations/F2-roles-and-permissions.md` §Marketing · `prd/modules/M03-marketing.md` |
...
| BM-14 | P1 | context | context → ['BM-41', 'prd/modules/M12-platform-billing.md'] | T-FCORE-010 |
...
| BM-43 | P1 | context | context → ['prd/modules/M01-onboarding-and-tenant-config.md', 'prd/foundations/F1-global-market-framework.md', 'prd/modules/M06-proposals.md'] | realized-by: `prd/modules/M01-onboarding-and-tenant-config.md` · `prd/foundations/F1-global-market-framework.md` · `prd/modules/M06-proposals.md` |
| BM-44 | P1 | context | context → ['BM-08', 'BM-41'] | T-FCORE-010 |
| BM-45 | P1 | context | context → ['BM-05', 'prd/foundations/F1-global-market-framework.md'] | realized-by: BM-05 (LAW) · `prd/foundations/F1-global-market-framework.md` |
| BM-46 | P1 | context | context → ['BM-17', 'BM-18', 'BM-41'] | T-FCORE-011 |
| BM-47 | P1 | context | context → ['prd/modules/M13-dashboards-and-reporting.md', 'BM-28'] | T-FCORE-013 |

### prd/foundations/F1-global-market-framework.md
...
### prd/foundations/F2-roles-and-permissions.md
...
### prd/foundations/F3-localization.md
...
*This section was `prd/foundations/F4-offline-and-sync.md`'s. That document was deleted whole
...
### prd/foundations/F5-customer-link.md
...
| F5-04 | P0 | context | context → ['prd/foundations/F5-customer-link.md'] | realized-by: prd/foundations/F5-customer-link.md |
| F5-05 | P0 | policy | policy | LAW |
| F5-06 | P0 | context | context → ['prd/modules/M02-crm-and-leads.md', 'F5-32', 'F5-61', 'F5-72'] | T-F5-001 |
...
### prd/foundations/F6-notifications-and-search.md
...
### prd/foundations/F7-design-language.md
...
### prd/foundations/F8-data-honesty.md
...
### prd/modules/M01-onboarding-and-tenant-config.md
...
| M03-16 | P2 | context | context → registers/enhancements.md (REC, not v1 scope) | realized-by: prd/registers/enhancements.md (REC, not v1 scope) |
| M03-17 | P2 | context | context → registers/enhancements.md (REC, not v1 scope) | realized-by: prd/registers/enhancements.md (REC, not v1 scope) |
...
| M03-25 | P0 | context | context → modules/M07 (M07-47, M07-48, M07-27) and M02-14; appears on Channel Health | realized-by: prd/modules/M07-sales-execution.md (M07-47, M07-48, M07-27) and M02-14; appears on Channel Health (SCR-M03-08) |
...
| M03-37 | P2 | context | context → registers/enhancements.md (REC); modules/M07 would own implementation | realized-by: prd/registers/enhancements.md (REC); modules/M07 would own implementation |
...
| M03-43 | P2 | context | context → registers/enhancements.md (REC; Q6 disclosure floor an input) | realized-by: prd/registers/enhancements.md (REC; Q6 disclosure floor an input) |
...
### prd/modules/M05-studio/01-step1-site-setup.md
...
### prd/modules/M05-studio/02-step2-roof.md
...
### prd/modules/M05-studio/04-step4-components.md
...
| MS4-26 | P2 | context | context → informative | realized-by: Recommended Enhancement, explicitly not v2 scope — the enhancements register and the design spec §10 carry it, and §5 non-goals of `prd/modules/M05-studio/04-step4-components.md` records the exclusion ("battery economics modelling (MS4-26, REC)"). No v2 task builds it. |
...
### prd/modules/M05-studio/07-step8-sld.md
...
### prd/modules/M05-studio/08-customer-surfaces.md
...
### prd/modules/M05-studio/10-done-and-installation.md
...
### prd/modules/M05-studio/11-shell-and-platform.md
...
| M06-33 | P2 | context | context → registers/enhancements.md (future battery-economics layer riding F8-23 honesty laws) | realized-by: prd/registers/enhancements.md |
...
| Row | Tier | Type | Where | Task |
|---|---|---|---|---|
| M09-01 | P0 | context | context → M09.2-M09.10 feature-area rows; registers/enhancements.md | realized-by: prd/modules/M09-field-workforce.md §M09.2–§M09.10 rows (this file); prd/registers/enhancements.md |
...
| M09-06 | P0 | context | context → M09 §5 non-goals; M09-09 | realized-by: prd/modules/M09-field-workforce.md §5 non-goals; M09-09 (LAW) |
...
### prd/modules/M11-payments-and-collections.md
...
carrying a tiered table row in `prd/foundations/*.md`, `prd/modules/**/*.md` or `prd/0*.md`:
