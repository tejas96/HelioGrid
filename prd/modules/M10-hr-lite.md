...
| M10-10 | **Deactivated people stay in the register.** Deactivation hides a person from assignment pickers and ends sessions (F2-20, via M01); it never removes them from the people list, their record, their documents or their history — "deactivate, never delete." The list shows status plainly. | `SRC` — `DOC08.deactivate-never-delete` (docs/08; consumed via `F2-20` — referenced, not re-appended, per Task 5's disposition) | P0 |
