...
Sources: inventory ledger `prd/_process/studio/inventory/step1-setup.md` (115 CODE keys, 33/33 area tests passing) · sitting rulings `prd/_process/studio/sittings/step1-setup-rulings.md` (S1-1…S1-6) · census A.10-1/A.10-2 cross-refs.
