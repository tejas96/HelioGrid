...
- Create: `prd/_process/extraction/studio-census-checklist.md` — every census entry from `prd/modules/M05-studio/studio-census.md` as a checkbox line (key `SC.<section>.<i>`).
