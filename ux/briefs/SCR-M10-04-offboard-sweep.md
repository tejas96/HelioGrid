...
**Module:** M10 · HR-lite · **Personas:** EPC Owner (executes), HR/Admin (prepares, read-only) · **Context of use:** a deliberate, sit-down act — "an Owner running an offboard can do it all in one sitting, while an HR/Admin preparing one can only look" (`prd/modules/M10-hr-lite.md` §M10.4 behavior detail).
