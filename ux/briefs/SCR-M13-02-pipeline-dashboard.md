...
**This brief serves one persona: the Sales Executive.** It carries one row, M13-31, and draws the rep's own-scoped step-back and nothing else. The EPC Owner's and Sales Manager's home is a different screen — `ux/briefs/SCR-M13-01-owner-dashboard.md` (SCR-M13-01), which carries M13-29, M13-30, PS-07 and PS-09 and draws the owner and team-scoped manager renderings in full. Do not draw an owner or manager rendering here.

**Module:** M13 · Dashboards & reporting · **Personas:** Sales Executive · **Context of use:** for the Sales Executive this is the secondary "how am I doing" step-back — mobile-first, genuinely, like everything in their day (per `prd/02-personas.md` §Sales Executive, Primary surfaces); it is never how a rep decides who to call.
