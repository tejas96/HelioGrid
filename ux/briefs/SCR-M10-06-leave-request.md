...
**Module:** M10 · HR-lite · **Personas:** Employee (all presets — requesting is `F2.M10.request-leave`, every preset, own-scope; `prd/modules/M10-hr-lite.md` §M10.5 permissions) · **Context of use:** every employee persona, including field crews on phones — requests are the employee's own act on their own record; deciding happens elsewhere (HR/Admin's mobile one-tap approvals, §2).
