...
**Module:** M10 · HR-lite · **Personas:** HR/Admin (primary), EPC Owner · **Context of use:** web-first desk work — "records, documents, imports and the people list are desk work" (`prd/02-personas.md` §HR/Admin, Primary surfaces); mobile still full-featured (`prd/modules/M10-hr-lite.md` §2).
